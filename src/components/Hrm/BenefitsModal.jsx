...
import { FaCalendarAlt, FaEdit, FaSave, FaTimes, FaFilePdf } from "react-icons/fa";

export default function BenefitsModal({ show, handleClose, benefitItems = [] }) {
        ...
        >
          <Row className="text-center">
            <Col md={3}>
              ...
              <p className="text-muted">Total Benefits Value</p>
            </Col>
            <Col md={3}>
              <strong>9</strong>
              <p className="text-muted">Active Benefits</p>
            </Col>
            <Col md={3}>
              <strong>2025-12-31</strong>
              <p className="text-muted">Next Renewal</p>
            </Col>
            <Col md={3}>
              <strong>4.2/5</strong>
        ...
        <Row className="g-3">
          {benefitItems.map((item) => (
            <Col md={3} key={item.id}>
              <Card
                className="benefit-card shadow-sm h-100"
                ...
                <Card.Body>
                  ...
                  {viewItem === item.id && (
                    <div style={{ fontSize: "0.85rem", color: "#6c757d" }}>
                      <p className="mb-1">
                        View content for <strong>{item.label}</strong>...
                      </p>
                    </div>
                  )}
